...
const p1 = new Contador(
  ...
  partidaEnMemoria && partidaEnMemoria[p1Nombre]
    ? partidaEnMemoria[p1Nombre]
    : 0
);
const p2 = new Contador(
  p2Nombre,
  document.getElementById("jugador2Container"),
  partidaEnMemoria && partidaEnMemoria[p2Nombre]
    ? partidaEnMemoria[p2Nombre]
    : 0
);
...
document
  ...
  .forEach((boton) => boton.addEventListener("click", guardarPartida));
